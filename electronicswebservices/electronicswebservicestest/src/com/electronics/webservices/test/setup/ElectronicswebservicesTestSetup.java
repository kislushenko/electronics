 ...
 */
package com.electronics.webservices.test.setup;
...
public class ElectronicswebservicesTestSetup extends AbstractSystemSetup
{
	...
	private static final Logger LOG = Logger.getLogger(ElectronicswebservicesTestSetup.class);
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		getSetupImpexService().importImpexFile("/electronicswebservicestest/import/sampledata/user-orders.impex", true, false);
		getSetupImpexService().importImpexFile("/electronicswebservicestest/import/sampledata/paymentmodes.impex", true, false);
	...
	{
		return Config.getBoolean("electronicswebservicestest.enableWsIntegrationTest", false);
	}
		...
		if (extensionNames.contains("acceleratorwebservicesaddon") || extensionNames.contains("acceleratorocc"))
		{
			storeNames.forEach(store -> {
				getSetupImpexService().importImpexFile(
						String.format("/electronicswebservicestest/import/acceleratorwebservicesaddon/%s/solr.impex", store), true, true);
				getSetupImpexService().importImpexFile(
						String.format("/electronicswebservicestest/import/acceleratorwebservicesaddon/%s/site.impex", store), true, true);
			});
		}

		if (extensionNames.contains("yacceleratorfulfilmentprocess"))
		{
			getSetupImpexService().importImpexFile("/electronicswebservicestest/import/orderprocess/store.impex", true, true);
		}

		if (extensionNames.contains("yacceleratorordermanagement"))
		{
			getSetupImpexService().importImpexFile(
					"/electronicswebservicestest/import/ordermanagement/projectdata-dynamic-business-process-order.impex", true);
			getSetupImpexService().importImpexFile(
					"/electronicswebservicestest/import/ordermanagement/projectdata-dynamic-business-process-consignment.impex", true);
			getSetupImpexService().importImpexFile(
					"/electronicswebservicestest/import/ordermanagement/projectdata-dynamic-business-process-return.impex", true);
			getSetupImpexService().importImpexFile(
					"/electronicswebservicestest/import/ordermanagement/projectdata-dynamic-business-process-sendReturnLabelEmail.impex",
					true);
			getSetupImpexService().importImpexFile("/electronicswebservicestest/import/ordermanagement/store.impex", true, true);
		}
	}
	...
	public void initializePromotionEngineModule()
	{
		getSetupImpexService()
				.importImpexFile("/electronicswebservicestest/import/promotionengine/promotionsmodule.impex", true, false);
	}
	...
	protected void loadIntegrationData()
	{
		...
		{
			getSetupImpexService().importImpexFile("/electronicswebservicestest/import/integration/cis-integration-data.impex", true);
		}

		if (extensionNames.contains("omssampledata"))
		{
			getSetupImpexService().importImpexFile("/electronicswebservicestest/import/integration/oms-integration-data.impex", true);
		}
	}
	...
	{
		getSetupImpexService().importImpexFile(
				"/electronicswebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-categories.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/electronicswebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/electronicswebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-prices.impex",
				true, false);
		getSetupImpexService().importImpexFile(
				"/electronicswebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-stock-levels.impex",
				true, false);
