...
public class TestSetupUtils
{
	...
	private static void setupCommerce(final BiConsumer<ElectronicswebservicesTestSetup, SystemSetupContext> triggerEqualsValidator)
	{
		final ElectronicswebservicesTestSetup setup = getCommerceWebServicesTestSetup();
	...
	private static ElectronicswebservicesTestSetup getCommerceWebServicesTestSetup()
	{
		return Registry.getApplicationContext().getBean("yCommerceWebServicesTestSetup", ElectronicswebservicesTestSetup.class);
	}
	...
	private static SystemSetupContext createSystemSetupContext()
	{
		...
		params.put("electronicswebservicestest_sample", new String[] { "true" });
		params.put("lucenesearch_rebuild", new String[] { "true" });
		params.put("lucenesearch_update.index.configuration", new String[] { "true" });

		return new SystemSetupContext(params, Type.ALL, Process.ALL, "electronicswebservicestest");
	}
	...
	{
		if (!Config.getBoolean("electronicswebservicestest.embedded.server.enabled", true))
		{
