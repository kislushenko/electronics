...
import com.electronics.webservices.test.test.groovy.webservicetests.SSLIssuesIgnoringHttpClientFactory
...
abstract class AbstractSpockTest extends Specification {
	private static String LOG4J_PROPERTIES_CLASS_PATH = "electronicswebservicestest/log4j.properties";
	...
	protected static ConfigObject config = TestConfigFactory.createConfig("v2", "/electronicswebservicestest/groovytests-property-file.groovy");
	...
	protected static final String getBasePathWithIntegrationSite() {
		def enableWsIntegrationTest = Config.getBoolean("electronicswebservicestest.enableWsIntegrationTest", false);
