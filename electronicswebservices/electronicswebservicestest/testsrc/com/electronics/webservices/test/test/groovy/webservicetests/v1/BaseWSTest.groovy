...
import com.electronics.webservices.test.test.groovy.webservicetests.TestNamePrinter
import com.electronics.webservices.test.test.groovy.webservicetests.TestUtil
import com.electronics.webservices.test.test.groovy.webservicetests.config.TestConfigFactory
import com.electronics.webservices.test.test.groovy.webservicetests.docu.BaseWSTestWatcher
...
class BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("electronicswebservicestest.enableV1", false))
	}
	...
	protected BaseWSTest() {
		config = TestConfigFactory.createConfig("v1", "/electronicswebservicestest/groovytests-property-file.groovy");
