 ...
 */
package com.electronics.webservices.core.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.electronics.webservices.core.constants.YcommercewebservicesConstants;
import com.electronics.webservices.core.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "electronicswebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "electronicswebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "electronicswebservices.oauth2.tokenUrl";

	private static final String DESC = "electronicswebservices.v2.description";
	private static final String TITLE = "electronicswebservices.v2.title";
	private static final String VERSION = "electronicswebservices.v2.version";
	private static final String LICENSE = "electronicswebservices.v2.license";
	private static final String LICENSE_URL = "electronicswebservices.v2.license.url";
